...
public class MainActivity extends Activity {
    ...
    String[] menus = new String[]{"DeviceHelper", "StorageHelper", "BluetoothHelper", "WifiHelper", "PowerManagerHelper"};

    String[] permissions = new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.READ_PHONE_STATE, Manifest.permission.ACCESS_FINE_LOCATION};
